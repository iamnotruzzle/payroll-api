            ...
            <div class="mt-4 space-y-3">
                ...
                @if ($computationType === 'formula')
                    <div>
                        ...
                        <p class="mt-1 text-xs text-slate-500">Allowed variables: basic_salary, salary, sg, step, hazard_rate, working_days, leave_days, paid_days, prior variable names, max(), and min().</p>
