    ...
    <table class="min-w-[1800px] divide-y divide-slate-200 text-sm">
        <thead class="bg-slate-50 text-left text-xs uppercase text-slate-500">
            <tr>
                ...
                @endforeach
                <th colspan="4" class="border-b border-slate-200 px-4 py-3 text-center">Net Pay Distribution</th>
            </tr>
            <tr>
        ...
        <tbody class="divide-y divide-slate-100">
            ...
            @empty
                <tr>
                    <td colspan="{{ 15 + $compensations->count() + $loanColumnCount }}" class="px-4 py-8 text-center text-slate-500">
