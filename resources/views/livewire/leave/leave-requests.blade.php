                    ...
                    <tr wire:key="leave-{{ $leave->leave_id }}">
                        ...
                        <td class="px-4 py-3 text-right whitespace-nowrap">
                            ...
                            @if ($pending && $canRequest)
                                <button wire:click="edit({{ $leave->leave_id }})" type="button" class="rounded-md border border-slate-300 bg-white px-3 py-2 text-sm font-medium hover:bg-slate-50">Edit</button>
                ...
                <form wire:submit="save" class="flex min-h-0 flex-1 flex-col">
                    <div class="min-h-0 flex-1 space-y-4 overflow-y-auto px-5 py-4">
                        ...
                        <label class="block">
                            ...
                            <textarea wire:model="remarks" rows="3" class="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm" placeholder="Reason / details"></textarea>
                            @error('remarks') <span class="mt-1 block text-xs text-red-600">{{ $message }}</span> @enderror
                        </label>
                    </div>
