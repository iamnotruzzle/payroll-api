...
class PdsPrintPresenter
{
    ...
    public function present(string $empId, ?string $backRoute = null): array
    {
        ...
        return [
            ...
            'birthdate' => $this->dmy($employee->birthdate),
            'birthplace' => $this->na($employee->birthplace),
            'sex' => $this->na($employee->gender),
            'sexMale' => $this->isSex($employee->gender, 'male'),
            'sexFemale' => $this->isSex($employee->gender, 'female'),
            'civilStatus' => $this->na($employee->civil_stat),
            'civilFlags' => $this->civilFlags($employee->civil_stat),
            'height' => $this->na($employee->height),
            'weight' => $this->na($employee->weight),
            'bloodType' => $this->na($employee->blood_type),
            'gsis' => $this->na($employee->gsis_no),
            'pagibig' => $this->na($employee->pagibig_no),
            'philhealth' => $this->na($employee->phic_no),
            'sss' => $this->na($employee->sss_no),
            'tin' => $this->na($employee->tin_no),
            'umid' => $this->na($employee->govid_no),
            'philsys' => 'N/A',
            'citizenship' => $this->na($employee->citizenship_id),
            'govIdType' => $this->na($employee->gov_id),
            'govIdDatePlace' => $this->na($employee->govid_dateplace),
            'isFilipino' => $this->isFilipino($employee->citizenship_id),
            'residential' => $this->splitAddress(null),
            'permanent' => $this->splitAddress(null),
            'telephone' => $this->na($employee->tel_no),
            'mobile' => $this->na($employee->mobile_no),
            'email' => $this->na($employee->email),
