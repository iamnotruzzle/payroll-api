    ...
    private function permissions(): array
    {
        return [
            ...
            'Self Service' => [
                ...
                'self-service.dtr' => 'View own DTR and use Time Punch',
                'self-service.training' => 'View and file own training / TARF requests',
                'self-service.ipcr' => 'View own IPCR commitments and ratings',
            ],
            'Employees' => [
    ...
    private function roles(): array
    {
        ...
        return [
            ...
            'employee' => [
                ...
                'description' => 'Self-service access for profile, leave, schedule, payslip, training, IPCR, and help.',
                'permissions' => [
                    'self-service.access',
                    'self-service.profile',
                    'self-service.leave',
